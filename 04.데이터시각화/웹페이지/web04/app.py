...
def score_data():
    ...
    table_info = df_info.to_html(classes='table table-success table-striped-columns table-hover', index=False)
    table_score = df_score.to_html(classes='table table-success table-striped-columns table-hover', index=False)
